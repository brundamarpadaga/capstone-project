...
class SubscriberControllerTest {
    ...
    public void testGetAllSubs() throws Exception {
        ...
        subscriber1.setSubscriberID("123456789123456789123456");
        ...
        subscriber2.setSubscriberID("123456789123456789123456");
    ...
    public void testGetSubscriberDetails ()  throws Exception{
        ...
        Mockito.when(subscriberService.getAllSubscriberDetails()).thenReturn(subscribersWithPricing);

        mockMvc.perform(MockMvcRequestBuilders.get("/api/subscribersWithPlanPrice"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON))
    ...
    void testAddSubscriber() throws Exception {
        ...
        Mockito.when(subscriberService.addSubscriber(subscriber)).thenReturn("Subscribed"); // Modify this line accordingly

        mockMvc.perform(MockMvcRequestBuilders.post("/api/subscriber/add")
